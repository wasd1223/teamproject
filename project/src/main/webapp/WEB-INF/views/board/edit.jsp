...
<div style="display: inline-block; text-align: left;">
	...
	<form id="form2" name="form2" method="post" enctype="multipart/form-data">
		...
		<div>
			첨부파일을 등록하세요
			<img src="${path}/images/board/${dto.picture_url}" width="200px"
						height="200px"> <br> 
		...
		<div style="text-align: center;">
			<input type="button" value="수정"
					onclick="board_update()" class="btn btn-lg btn-success btn-block"
					style="width: 250px; display: inline-block; margin-bottom: 10px; margin-top: 10px;">
					<input type="button" value="삭제"
					onclick="board_delete()" class="btn btn-lg btn-success btn-block"
					style="width: 250px; display: inline-block; margin-bottom: 10px; margin-top: 10px;">
